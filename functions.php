...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function FaithChild_enqueue_child_styles() {
		...
		wp_enqueue_style( 'millwood-style', get_stylesheet_directory_uri() . '/assets/millwood-church-10-30-2021.css' );
		...
		wp_enqueue_script( 'customjs', get_stylesheet_directory_uri() . '/assets/millwood-10-30-2021.js' );
